...
public class PhoneValidator implements Validator< String> {
	...
	public void validate( FacesContext context, UIComponent component, String value) throws ValidatorException {
		...
		if ( value == null) {
			FacesMessage msg = new FacesMessage( "Phone Number should not be empty", "The phone number is empty");
		...
		Matcher match = PHONE_PATTERN.matcher(value);
		 ...
		 if(!match.matches()) {
			...
			FacesMessage msg = new FacesMessage( "Phone Number is not in correct format", "Invalid phone Numberformat.Please use right format");
